...
export function Works({ sectionsRefs }: privateProps) {
  const updateSectionRefs = (ref: HTMLElement) => {
    if (sectionsRefs.current) sectionsRefs.current.work = ref;
  };
  return (
    <section ref={updateSectionRefs} className="work section right">
