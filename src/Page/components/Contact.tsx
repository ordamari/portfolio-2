...
export function Contact({ sectionsRefs }: privateProps) {
  const updateSectionRefs = (ref: HTMLElement) => {
    if (sectionsRefs.current) sectionsRefs.current.contact = ref;
  };

  return (
    <section ref={updateSectionRefs} className="contact section left">
